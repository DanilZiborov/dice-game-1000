    ...
    <div className="flex h-full flex-none flex-col items-start justify-around">
      ...
      <div className="flex flex-col items-start gap-6">
        ...
        <div className="flex items-center gap-6">
          <span className={clsx(rules.withBolts ? 'text-white' : 'text-cyber-disabled')}>3 болта снимают</span>
          ...
          />
          <span className={clsx('ml-2', rules.withBolts ? 'text-white' : 'text-cyber-disabled')}>очков</span>
        </div>
      </div>
      <div className="flex flex-col items-start gap-6">
        <CustomCheckbox
        ...
        <div className="flex items-center gap-6">
          <span className={clsx(rules.withOvertake ? 'text-white' : 'text-cyber-disabled')}>при обгоне снимается</span>
          <CustomNumericInputWithSteps
          ...
          />
          <span className={clsx('ml-2', rules.withOvertake ? 'text-white' : 'text-cyber-disabled')}>очков</span>
        </div>
      </div>
