    ...
    <div className="mx-auto py-10 leading-relaxed">
      ...
      <section className="mb-12">
        ...
        <div className="mt-6 border-l-4 border-gray-200 pl-6">
          <p className="italic">
            В приложении можно активировать такой вариант бочки в настройках партии. Там он называется «Режим быстрой
            победы». Он сокращает продолжительность партии, однако делает её более предсказуемой.
          </p>
        </div>
      </section>
